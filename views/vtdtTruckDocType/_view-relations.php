            ...
            $this->widget(
                ...
                array(
                    ...
                    'buttons' => array(
                        array(
                            'icon' => 'icon-list-alt',
                            'url' =>  array('//trucks/vtdcTruckDoc/admin','VtdcTruckDoc' => array('vtdc_vtdt_id' => $model->{$model->tableSchema->primaryKey}))
                        ),
                        array(
                'icon' => 'icon-plus',
                'url' => array(
                    '//trucks/vtdcTruckDoc/create',
                    'VtdcTruckDoc' => array('vtdc_vtdt_id' => $model->{$model->tableSchema->primaryKey})
                )
            ),
