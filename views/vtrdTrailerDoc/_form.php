        ...
        <div class="span12">
            ...
            <div class="form-horizontal">
                ...
                array(
                    ...
                    <div class="control-group">
                        <div class='control-label'>
                            <?php echo $form->labelEx($model, 'vtrd_fixr_id') ?>
                        </div>
                        <div class='controls'>
                            <span class="tooltip-wrapper" data-toggle='tooltip' data-placement="right"
                                 title='<?php echo (($t = Yii::t('TrucksModule.model', 'tooltip.vtrd_fixr_id')) != 'tooltip.vtrd_fixr_id')?$t:'' ?>'>
                                <?php
                            echo $form->textField($model, 'vtrd_fixr_id', array('size' => 10, 'maxlength' => 10));
                            echo $form->error($model,'vtrd_fixr_id')
                            ?>                            </span>
                        </div>
                    </div>
                    <?php  ?>
    ...
    <div class="form-actions" style="visibility: hidden; height: 1px">
        ...
        <?php
            ...
            Yii::t('TrucksModule.crud', 'Cancel'), array(
                'submit' => (isset($_GET['returnUrl']))?$_GET['returnUrl']:array('vtrdTrailerDoc/admin'),
                'class' => 'btn'
            ));
