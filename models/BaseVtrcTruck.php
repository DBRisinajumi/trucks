...
abstract class BaseVtrcTruck extends CActiveRecord
{
    ...
    public function rules()
    {
        return array_merge(
            parent::rules(), array(
                array('vtrc_cmmp_id, vtrc_car_reg_nr, vtrc_year, vtrc_car_certificate_number, vtrc_self_weight, vtrc_fuel_consumption, vtrc_year_mileage, vtrc_leased_from_cmmp_id, vtrc_purchase_value, vtrc_notes', 'default', 'setOnEmpty' => true, 'value' => null),
                ...
                array('vtrc_id, vtrc_cmmp_id, vtrc_car_reg_nr, vtrc_year, vtrc_car_certificate_number, vtrc_self_weight, vtrc_fuel_consumption, vtrc_year_mileage, vtrc_leased_from_cmmp_id, vtrc_purchase_value, vtrc_notes', 'safe', 'on' => 'search'),
            )
        );
    }
